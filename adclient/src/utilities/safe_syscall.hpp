    ...
    public:
        SYSCALL_FORCEINLINE ~create_function() noexcept
        {
            if (this->_allocated_memory) {
                SAFE_CALL(VirtualFree)(this->_allocated_memory, 0, MEM_RELEASE);
            ...
            : _export_hash(export_hash)
        {
            ...
            std::vector<uint8_t> shellcode = {
                ...
                0x00,
                0x00,
                0x00,// mov edx, DWORD PTR fs:0xc0 (
                0xFF,
                0xD2,// call edx
                0xC2,
                0x04,
...
#endif
            this->_allocated_memory = SAFE_CALL(VirtualAlloc)(nullptr,
                                                              sizeof(shellcode),
